...
<td><a href="http://acadweb1.salisbury.edu/~br2214/registeraccount.php">Register a new account.</a></td>
...
while($row = mysql_fetch_assoc($result)) 
{
    ...
    foreach($row as $cvalue) {
        print 'Hello Admin '.$cvalue.'<a href="http://acadweb1.salisbury.edu/~br2214/Project2Maintenance.php"> >>Begin Maintenance<< </a></p>
';}
    }
...
<p><a href="http://acadweb1.salisbury.edu/~br2214/Project2Next.php">
...
<a href="http://acadweb1.salisbury.edu/~br2214/aboutus.php">About Us</a>
</td>
</tr>
